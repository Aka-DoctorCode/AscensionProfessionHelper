...
**Ascension Profession Helper** is a streamlined utility designed to make destroying items (Disenchanting, Milling, Prospecting) as easy as possible. It features a dynamically updating queue of items in your inventory, automatic skipping of non-destroyables, and an easy-to-use scroll wheel binding.
...
**Ascension Profession Helper** es una utilidad diseñada para hacer que destruir objetos (Desencantar, Moler, Prospectar) sea lo más fácil posible. Cuenta con una cola que se actualiza dinámicamente, omisión automática de objetos que no se pueden destruir, y un atajo fácil de usar para la rueda del ratón.
